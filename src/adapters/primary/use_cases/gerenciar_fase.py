...
def iniciar_fase(menu_fase, jogo_model, jogo_ui, fase_ui, item_servico, personagem_servico, tempo_servico, tamanho_tela_largura, tamanho_tela_altura):
    while True:  
        fase = criar_fase(jogo_model.fase_atual, jogo_ui.personagem, jogo_ui.itens_ruins)
        
        fase_service = FaseService(fase, fase_ui, item_servico, personagem_servico, tempo_servico, jogo_model, tamanho_tela_largura, tamanho_tela_altura)
